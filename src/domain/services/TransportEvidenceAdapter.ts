  ...
  public static normalize(input: TransportAdapterInput): NormalizedTransportEvidence {
    ...
    if (osm?.distanceToArterialMeters !== null && osm?.distanceToArterialMeters !== undefined) {
      ...
      majorRoad = {
        ...
        relation: 'exact',
        lowerBoundMeters: null,
        endpoint: osm.auditTrail?.endpointsUsed?.majorRoad || 'https://overpass-api.de/api/interpreter',
        isFallback: false,
        type: 'major_road',
    ...
    if (osm?.distanceToHospitalMeters !== null && osm?.distanceToHospitalMeters !== undefined) {
      ...
      healthcare = {
        ...
        relation: 'exact',
        lowerBoundMeters: null,
        endpoint: osm.auditTrail?.endpointsUsed?.healthcare || 'https://overpass-api.de/api/interpreter',
        isFallback: false,
        type: 'healthcare',
    ...
    if (osm?.distanceToNearestTransitMeters !== null && osm?.distanceToNearestTransitMeters !== undefined) {
      ...
      transit = {
        ...
        relation: 'exact',
        lowerBoundMeters: null,
        endpoint: osm.auditTrail?.endpointsUsed?.transit || 'https://overpass-api.de/api/interpreter',
        isFallback: false,
        type: 'transit',
    ...
    if (osm?.distanceToFireStationMeters !== null && osm?.distanceToFireStationMeters !== undefined) {
      ...
      fireStation = {
        ...
        relation: 'exact',
        lowerBoundMeters: null,
        endpoint: osm.auditTrail?.endpointsUsed?.fireStation || 'https://overpass-api.de/api/interpreter',
        isFallback: false,
        type: 'fire_station',
    ...
    if (osm?.distanceToAssemblyPointMeters !== null && osm?.distanceToAssemblyPointMeters !== undefined) {
      ...
      const distKm = Math.round((distM / 1000) * 10) / 10;
      assemblyPoint = {
        name: osm.nearestAssemblyPointName || 'Titik Kumpul Evakuasi Terdekat',
        distanceMeters: distM,
        distanceKm: distKm,
        status: 'success_exact',
        source: 'overpass',
        ...
        isOfficial: false,
        type: 'assembly_point',
        facilityType: osm.assemblyPointFacilityType || 'assembly_point',
